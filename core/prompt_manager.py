...
from core.types.base import ExtractedClass, ExtractedFunction, ProcessingResult, MetricData, TokenUsage, DocumentationContext, ExtractedArgument
...
class PromptManager:
    ...
    async def create_documentation_prompt(
        ...
        try:
            ...
            self.logger.error(
                f"Error generating documentation prompt: {e}",
                exc_info=True,
                extra={"context_metadata": context.metadata},
            )
            return ProcessingResult(
                content={},
                usage={},
