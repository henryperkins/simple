            ...
            if isinstance(node, ast.ClassDef):
                try:
                    ...
                    if "name" not in class_info:
                        class_info["name"] = getattr(node, 'name', 'unknown')
                    print(f"Extracted class info: {class_info}")  # Print statement
                ...
                try:
                    ...
                    if "name" not in func_info:
                        func_info["name"] = getattr(node, 'name', 'unknown')
                    print(f"Extracted function info: {func_info}")  # Print statement
